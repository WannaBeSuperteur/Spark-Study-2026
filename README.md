...
| **08.09 일 - 08.11 화 (3d)** | **4. 메모리 관리 및 성능 튜닝**                                              | 💨       |
...
| 08.10 월 - 08.11 화 (2d)     | - 4-4. Spark UI 분석 및 병목 진단                                         | ⬜        |
| **08.12 수 - 08.15 토 (4d)** | **5. 실전 트러블슈팅 및 확장**                                               | ⬜        |
| 08.12 수 - 08.13 목 (2d)     | - 5-1. Out of Memory (OOM) 예외 트러블슈팅                                | ⬜        |
