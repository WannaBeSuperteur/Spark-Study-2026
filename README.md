...
| **08.09 일 + 08.14 금 (2d)** | **4. 메모리 관리 및 성능 튜닝**                                              | 💨       |
...
| 08.14 금 (1d)               | - 4-4. Spark UI 분석 및 병목 진단                                         | ⬜        |
| **08.14 금 - 08.15 토 (2d)** | **5. 실전 트러블슈팅 및 확장**                                               | ⬜        |
| 08.14 금 (1d)               | - 5-1. Out of Memory (OOM) 예외 트러블슈팅                                | ⬜        |
| 08.15 토 (1d)               | - 5-2. PySpark Pandas API (formerly Koalas) 연동                     | ⬜        |
